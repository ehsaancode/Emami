          ...
          <Card.Body>
            ...
            <div className="media d-flex mb-4">
              <img
                alt=""
                className="main-img-user avatar-lg mg-r-20 br-5"
                src={new URL('../../../assets/img/photos/blog4.jpg', import.meta.url).href}
              />
              <div className="media-body">
            ...
            <div className="media d-flex mb-3">
              <img
                alt=""
                className="main-img-user avatar-lg mg-r-20 br-5"
                src={new URL('../../../assets/img/photos/blog6.jpg', import.meta.url).href}
              />
              <div className="media-body">
                ...
                <div className="list-group-item list-group-item-action">
                  <div className="media mt-0">
                    <Link to={`${process.env.PUBLIC_URL}/pages/profile`}>
                      <img
                        className="avatar-lg rounded-circle me-3 my-auto"
                        src={new URL('../../../assets/img/faces/15.jpg', import.meta.url).href}
                        alt="description"
                      />
                    </Link>
                    <div className="media-body">
