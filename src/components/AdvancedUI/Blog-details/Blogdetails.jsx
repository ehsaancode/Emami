      ...
      <Row>
        <Col md={12} lg={12} xl={12} xxl={9}>
          <Card className="overflow-hidden">
            <div className="item7-card-img px-4 pt-4">
              <Link to="#"></Link>
              <img
                src={new URL('../../../assets/img/photos/blog.jpg', import.meta.url).href}
                alt="img"
                    ...
                    <div className="d-flex me-3">
                      <Link to={`${process.env.PUBLIC_URL}/pages/profile`}>
                        <img
                          className="media-object brround avatar-md"
                          alt="64x64"
                          src={new URL('../../../assets/img/faces/6.jpg', import.meta.url).href}
                        />
                      </Link>
                    </div>
                    <div className="media-body">
        ...
        <Col xxl={3} xl={12} lg={12} md={12}>
              ...
              <div className="text-center">
                <Link to={`${process.env.PUBLIC_URL}/advancedui/blogdetails`}>
                  <img
                    ...
                    src={new URL('../../../assets/img/photos/11.jpg', import.meta.url).href}
                    alt=""
                  />
                </Link>
            ...
            <Card.Body>
              <div className="media d-flex mb-4">
                <img
                  ...
                  src={new URL('../../../assets/img/photos/blog1.jpg', import.meta.url).href}
                />
                <div className="media-body">
              ...
              <div className="media d-flex mb-4">
                <img
                  alt=""
                  className="main-img-user avatar-lg mg-r-20 br-5"
                  src={new URL('../../../assets/img/photos/blog2.jpg', import.meta.url).href}
                />
                <div className="media-body">
              ...
              <div className="media d-flex mb-4">
                <img
                  alt=""
                  className="main-img-user avatar-lg mg-r-20 br-5"
                  src={new URL('../../../assets/img/photos/blog5.jpg', import.meta.url).href}
                />
                <div className="media-body">
          ...
          <Card className="custom-card overflow-hidden">
            ...
            {images.map((image) => {
                return (
                    <Col xl={4} lg={4} sm={6} key={image.id}>
                        <div className="brick">
