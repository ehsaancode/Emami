      ...
      <Row className="row-sm">
                ...
                <Carousel>
                  <Carousel.Item>
                    <img
                      ...
                      src={new URL('../../../assets/img/photos/8.jpg', import.meta.url).href}
                      alt="First slide"
                    />
                  </Carousel.Item>
                  <Carousel.Item>
                    <img
                       className="d-block w-100"
                      src={new URL('../../../assets/img/photos/18.jpg', import.meta.url).href}
                      alt="Second slide"
                    />
                  </Carousel.Item>
                  <Carousel.Item>
                    <img
                       className="d-block w-100"
                      src={new URL('../../../assets/img/photos/12.jpg', import.meta.url).href}
                      alt="Third slide"
                    />
                  </Carousel.Item>
                </Carousel>
                ...
                <Carousel>
                  ...
                  <Carousel.Item className="">
                    <img
                      alt="img"
                      className="d-block w-100"
                      src={new URL('../../../assets/img/photos/13.jpg', import.meta.url).href}
                    />
                  </Carousel.Item>
                ...
                <Carousel className=" slide" id="carouselExample3">
                  ...
                  <Carousel.Item className=" active">
                    <img
                      alt="img"
                      className="d-block w-100"
                      src={new URL('../../../assets/img/photos/14.jpg', import.meta.url).href}
                    />
                  </Carousel.Item>
                  <Carousel.Item className="">
                    <img
                      alt="img"
                      className="d-block w-100"
                      src={new URL('../../../assets/img/photos/15.jpg', import.meta.url).href}
                    />
                  </Carousel.Item>
                  <Carousel.Item className="">
                    <img
                      alt="img"
                      className="d-block w-100"
                      src={new URL('../../../assets/img/photos/16.jpg', import.meta.url).href}
                    />
                  </Carousel.Item>
                  {/* </div> */}
                </Carousel>
                ...
                <Carousel className=" bg-dark  slide" id="carouselExample4">
                  ...
                  <Carousel.Item>
                    <img
                      ...
                      src={new URL('../../../assets/img/photos/17.jpg', import.meta.url).href}
                    />
                  ...
                  <Carousel.Item className="">
                    <img
                      alt="img"
                      className="d-block w-100 op-3"
                      src={new URL('../../../assets/img/photos/19.jpg', import.meta.url).href}
                    />
                    <div className="carousel-caption d-none d-md-block">
                      <h5>Third Slide</h5>
                      <p className="tx-14">
                ...
                >
                  ...
                  <Carousel.Item className=" active">
                    <img
                      alt="img"
                      className="d-block w-100"
                      src={new URL('../../../assets/img/photos/4.jpg', import.meta.url).href}
                    />
                  </Carousel.Item>
                  <Carousel.Item className="">
                    <img
                      alt="img"
                      className="d-block w-100"
                      src={new URL('../../../assets/img/photos/1.jpg', import.meta.url).href}
                    />
                  </Carousel.Item>
                  <Carousel.Item className=" ">
                    <img
                      alt="img"
                      className="d-block w-100"
                      src={new URL('../../../assets/img/photos/2.jpg', import.meta.url).href}
                    />
                  </Carousel.Item>
                  {/* </div> */}
                </Carousel>
        ...
        <Col lg={12}md={12}>
          ...
          <div className="item">
            <Link to="#">
              <img
                src={new URL('../../../assets/img/photos/3.jpg', import.meta.url).href}
                alt=""
                className="br-5"
              />
            </Link>
          ...
          <div className="item">
            <Link to="#">
              <img
                src={new URL('../../../assets/img/photos/5.jpg', import.meta.url).href}
                alt=""
                className="br-5"
              />
            </Link>
          ...
          <div className="item">
            <Link to="#">
              <img
                src={new URL('../../../assets/img/photos/6.jpg', import.meta.url).href}
                alt=""
                className="br-5"
              />
            </Link>
          ...
          <div className="item">
            <Link to="#">
              <img
                src={new URL('../../../assets/img/photos/7.jpg', import.meta.url).href}
                alt=""
                className="br-5"
              />
            </Link>
          ...
          <div className="item">
            <Link to="#">
              <img
                src={new URL('../../../assets/img/photos/9.jpg', import.meta.url).href}
                alt=""
                className="br-5"
              />
            </Link>
          ...
          <div className="item">
            <Link to="#">
              <img
                src={new URL('../../../assets/img/photos/10.jpg', import.meta.url).href}
                alt=""
                className="br-5"
              />
            </Link>
