              ...
              <div className="text-wrap pb-3">
                <div className="file-image-1">
                  <div className="product-image">
                    <Link to={`${process.env.PUBLIC_URL}/app/filedetails`}>
                      <img
                        src={new URL('../../../assets/img/files/image.png', import.meta.url).href}
                        className="br-5"
                        alt=""
                      />
                    </Link>
                ...
                <div className="file-image-1">
                  <div className="product-image">
                    <Link to={`${process.env.PUBLIC_URL}/app/filedetails`}>
                      <img
                        src={new URL('../../../assets/img/files/doc.png', import.meta.url).href}
                        alt=""
                      />
                    </Link>
                    <ul className="icons">
                ...
                <div className="file-image-1">
                  <div className="product-image">
                    <Link to={`${process.env.PUBLIC_URL}/app/filedetails`}>
                      <img
                        src={new URL('../../../assets/img/files/file2.png', import.meta.url).href}
                        alt=""
                      />
                    </Link>
                    <ul className="icons">
                ...
                <div className="file-image-1">
                  <div className="product-image">
                    <Link to={`${process.env.PUBLIC_URL}/app/filedetails`}>
                      <img
                        src={new URL('../../../assets/img/files/file.png', import.meta.url).href}
                        alt=""
                      />
                    </Link>
                    <ul className="icons">
                ...
                <div className="file-image-1">
                  <div className="product-image">
                    <Link to={`${process.env.PUBLIC_URL}/app/filedetails`}>
                      <img
                        src={new URL('../../../assets/img/media/climate.jpg', import.meta.url).href}
                        className="br-5"
                        alt=""
                      />
                    </Link>
