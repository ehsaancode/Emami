      ...
      <Col xl={4} md={12} sm={12}>
        <Card className="custom-card">
          <Card.Body className=" text-center card-img-top-1">
            ...
            <img
              src={new URL('../../../assets/img/media/illustrate.png', import.meta.url).href}
              alt="counter"
      ...
      <Col xl={4} md={12} sm={12}>
        <Card className="custom-card">
          <Card.Body className=" text-center card-img-top-1">
            ...
            <img
              src={new URL('../../../assets/img/media/illustrate1.png', import.meta.url).href}
              alt="counter"
              className="wd-300 ht-300 "
            />
      ...
      <Col xl={4} md={12} sm={12}>
        <Card className="custom-card">
          <Card.Body className=" text-center card-img-top-1 ">
            ...
            <img
              src={new URL('../../../assets/img/media/illustrate2.png', import.meta.url).href}
              alt="counter"
              className="wd-300 ht-300 "
            />
