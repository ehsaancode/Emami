...
import { images, settings } from './data';
                    ...
                    <div className="slicksliders">
                      <div className="custom-card overflow-hidden mb-0 me-2 br-5">
                        <Link to={`${process.env.PUBLIC_URL}/app/filedetails`}>
                          <img className=""
                            alt=""
                            src={new URL('../../../assets/img/photos/fileimage4.jpg', import.meta.url).href}
                          />
                        </Link>
                      </div>
                    </div>
                    ...
                    <div className="slicksliders">
                      <div className="custom-card overflow-hidden mb-0 me-2 br-5">
                        <Link to={`${process.env.PUBLIC_URL}/app/filedetails`}>
                          <img className=""
                            alt=""
                            src={new URL('../../../assets/img/photos/fileimage1.jpg', import.meta.url).href}
                          />
                        </Link>
                      </div>
                    </div>
                    ...
                    <div className="slicksliders">
                      <div className="custom-card overflow-hidden mb-0 me-2 br-5">
                        <Link to={`${process.env.PUBLIC_URL}/app/filedetails`}>
                          <img className=""
                            alt=""
                            src={new URL('../../../assets/img/photos/fileimage2.jpg', import.meta.url).href}
                          />
                        </Link>
                      </div>
                    </div>
                    ...
                    <div className="slicksliders">
                      <div className="custom-card overflow-hidden mb-0 me-2 br-5">
                        <Link to={`${process.env.PUBLIC_URL}/app/filedetails`}>
                          <img className=""
                            alt=""
                            src={new URL('../../../assets/img/photos/fileimage3.jpg', import.meta.url).href}
                          />
                        </Link>
                      </div>
                    </div>
                    ...
                    <div className="slicksliders">
                      <div className="custom-card overflow-hidden mb-0 me-2 br-5">
                        <Link to={`${process.env.PUBLIC_URL}/app/filedetails`}>
                          <img className=""
                            alt=""
                            src={new URL('../../../assets/img/photos/fileimage5.jpg', import.meta.url).href}
                          />
                        </Link>
                      </div>
                    </div>
              ...
              <Row className=" row-sm file-detailimg">
                ...
                <ul id="lightgallery" className="list-unstyled row mb-0 px-2">
                  <LightgalleryProvider>
                    ...
                    {images.map((image) => {
                      return (
                        <Col as="li" key={image.id} sm={4} md={4} xl={3}>
                          <Link to="#">
