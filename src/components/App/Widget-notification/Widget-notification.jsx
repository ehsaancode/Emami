    ...
    <Row className="row-sm">
      <Col xl={4} md={6} lg={6}>
        <Card className="mg-b-20 text-center">
          <Card.Body className="h-100">
            <img
              src={new URL('../../../assets/img/svgicons/no-data.svg', import.meta.url).href}
              alt=""
              className="wd-35p"
            />
      ...
      <Col xl={4} md={6} lg={6}>
        <Card className="mg-b-20 text-center">
          <Card.Body className="h-100">
            <img
              src={new URL('../../../assets/img/svgicons/note_taking.svg', import.meta.url).href}
              alt=""
              className="wd-35p"
            />
      ...
      <Col xl={4} md={6} lg={6}>
        <Card className="mg-b-20 text-center">
          <Card.Body className="h-100">
            <img
              src={new URL('../../../assets/img/svgicons/imac.svg', import.meta.url).href}
              alt=""
              className="wd-40p"
            />
