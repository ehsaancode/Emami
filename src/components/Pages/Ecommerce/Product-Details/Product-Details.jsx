                            ...
                            <div id="thumbcarousel" className="carousel slide">
                              <div className="carousel-inner">
                                ...
                                >
                                  <SwiperSlide className="thumb my-2 me-1">
                                    <img alt=""
                                      src={new URL('../../../../assets/img/ecommerce/shirt-1.png', import.meta.url).href}
                                    />
                                  </SwiperSlide>
                                  <SwiperSlide className="thumb my-2 me-1">
                                    <img alt=""
                                      src={new URL('../../../../assets/img/ecommerce/shirt-2.png', import.meta.url).href}
                                    />
                                  </SwiperSlide>
                                  <SwiperSlide className="thumb my-2 me-1">
                                    <img alt=""
                                      src={new URL('../../../../assets/img/ecommerce/shirt-3.png', import.meta.url).href}
                                    />
                                  </SwiperSlide>
                                  <SwiperSlide className="thumb my-2 me-1">
                                    <img alt=""
                                      src={new URL('../../../../assets/img/ecommerce/shirt-4.png', import.meta.url).href}
                                    />
                                  </SwiperSlide>
                                </Swiper>
                              </div>
