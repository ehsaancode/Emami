                      ...
                      <Scrollbars style={{ height:"800px" }}>
                        ...
                        <div className="media">
                          <div className="main-img-user">
                            <img
                              alt=""
                              src={new URL('../../../../assets/img/faces/8.jpg', import.meta.url).href}
                            />
                          </div>
                          <div className="media-body">
                            <div className="media-contact-name">
                        ...
                        <div className="media">
                          <div className="main-img-user">
                            <img
                              alt=""
                              src={new URL('../../../../assets/img/faces/10.jpg', import.meta.url).href}
                            />
                          </div>
                          <div className="media-body">
                            <div className="media-contact-name">
                            ...
                            <div className="media-body">
                              ...
                              <div className="main-msg-wrapper p-0">
                                <img
                                  ...
                                  src={new URL('../../../../assets/img/ecommerce/6.jpg', import.meta.url).href}
                                />
                              </div>
                              <div>
                                <span>9:48 am</span>{" "}
