    ...
    <Row>
      ...
      <Col sm={12} xl={4} lg={12}>
        <Card className=" user-wideget user-wideget-widget widget-user">
          ...
          <div className="widget-user-image">
            <img
              src={new URL('../../assets/img/faces/17.jpg', import.meta.url).href}
              className="brround"
              alt="User Avatar"
            />
          </div>
      ...
      <Col sm={12} xl={4} lg={12}>
        <Card className=" user-wideget user-wideget-widget widget-user">
          ...
          <div className="widget-user-image">
            <img
              src={new URL('../../assets/img/faces/12.jpg', import.meta.url).href}
              className="brround"
              alt="User Avatar"
            />
          </div>
          ...
          <Card.Body>
            ...
            <div className="list d-flex align-items-center border-bottom py-3">
              <img
                alt=""
                className="avatar brround d-block cover-image"
                src={new URL('../../assets/img/faces/14.jpg', import.meta.url).href}
              />
            ...
            <div className="list d-flex align-items-center pt-3">
              <img
                alt=""
                className="avatar brround d-block cover-image"
                src={new URL('../../assets/img/faces/4.jpg', import.meta.url).href}
              />
        ...
        <Card>
          ...
          <Card.Body className="pd-y-7">
            ...
            <h6 className="tx-uppercase tx-spacing-1 tx-semibold tx-10 tx-color-02 mg-b-15">
              Overall product rating by the customer.
            </h6>
            ...
            <div className="wrapper d-flex justify-content-center image-group pb-3">
              ...
              />
              <img
                src={new URL('../../assets/img/faces/13.jpg', import.meta.url).href}
                alt="profile"
                className="img-xs rounded-circle"
              />
              <img
              ...
              />
              <img
                src={new URL('../../assets/img/faces/16.jpg', import.meta.url).href}
                alt="profile"
                className="img-xs rounded-circle"
              />
            </div>
            ...
            <ul className="list list-noborders pb-0 mb-0">
              <li className="list-item">
                ...
                <div className="ms-auto d-flex">
                  <img
                    ...
                    src={new URL('../../assets/img/ecommerce/03.jpg', import.meta.url).href}
                    alt="thumb images"
                  />
                  <img
                    className="img-sm"
                    src={new URL('../../assets/img/ecommerce/08.jpg', import.meta.url).href}
                    alt="thumb images"
                  />
                </div>
              </li>
              ...
              <li className="list-item">
                ...
                <div className="ms-auto d-flex">
                  ...
                  <img
                    className="img-sm"
                    src={new URL('../../assets/img/ecommerce/07.jpg', import.meta.url).href}
                    alt="thumb images"
                  />
                </div>
              </li>
              <li className="list-item">
                ...
                <div className="ms-auto d-flex">
                  ...
                  <img
                    className="img-sm"
                    src={new URL('../../assets/img/ecommerce/09.jpg', import.meta.url).href}
                    alt="thumb images"
                  />
                </div>
              </li>
            ...
            <div className="browser-stats">
              <div className="d-flex align-items-center item  border-bottom">
                <div className="d-flex">
                  <img
                    src={
                      new URL('../../assets/img/svgicons/chrome.svg', import.meta.url).href
                    }
                    alt="img"
              ...
              <div className="d-flex align-items-center item  border-bottom">
                <div className="d-flex">
                  <img
                    src={new URL('../../assets/img/svgicons/opera.svg', import.meta.url).href}
                    alt="img"
                    className="ht-30 wd-30 me-2"
                  />
                  <div className="">
              ...
              <div className="d-flex align-items-center item  border-bottom">
                <div className="d-flex">
                  <img
                    src={new URL('../../assets/img/svgicons/edge.svg', import.meta.url).href}
                    alt="img"
                    className="ht-30 wd-30 me-2"
                  />
                  <div className="">
              ...
              <div className="d-flex align-items-center item  border-bottom">
                <div className="d-flex">
                  <img
                    src={
                      new URL('../../assets/img/svgicons/firefox.svg', import.meta.url).href
                    }
                    alt="img"
                    className="ht-30 wd-30 me-2"
                  />
              ...
              <div className="d-flex align-items-center item border-bottom">
                <div className="d-flex">
                  <img
                    src={
                      new URL('../../assets/img/svgicons/uc-browser.svg', import.meta.url).href
                        .default
                    }
                    alt="img"
                    className="ht-30 wd-30 me-2"
              ...
              <div className="d-flex align-items-center item">
                <div className="d-flex">
                  <img
                    src={
                      new URL('../../assets/img/svgicons/safari.svg', import.meta.url).href
                    }
                    alt="img"
                    className="ht-30 wd-30 me-2"
                  />
