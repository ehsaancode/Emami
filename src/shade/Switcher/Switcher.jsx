...
export default function Switcher() {
    ...
    function changePrimaryColor() {
      ...
      localStorage.setItem("al fadly - crmPrimaryColor", userColor);
      // to store value as opacity 0.95 we use 95
      localStorage.setItem("al fadly - crmprimaryHoverColor", userColor + 95);
      localStorage.setItem("al fadly - crmprimaryBorderColor", userColor);
      localStorage.setItem("al fadly - crmprimaryTransparent", userColor + 20);
      ...
      localStorage.removeItem("al fadly - crmdarkPrimaryColor");
      localStorage.removeItem("al fadly - crmtransparentPrimaryColor");
      localStorage.removeItem("al fadly - crmtransparentBgColor");
      localStorage.removeItem("al fadly - crmtransparent-bgImgPrimaryColor");
      localStorage.removeItem("al fadly - crmBgImage");

      Switcherdata.name();
    }
    function darkPrimaryColor() {
      var userColor = document.getElementById("darkPrimaryColorID").value;
      localStorage.setItem("al fadly - crmdarkPrimaryColor", userColor);
      localStorage.setItem("al fadly - crmprimaryHoverColor", userColor + 95);
      localStorage.setItem("al fadly - crmprimaryBorderColor", userColor);
      localStorage.setItem("al fadly - crmprimaryTransparent", userColor + 20);
      ...
      localStorage.removeItem("al fadly - crmPrimaryColor");
      localStorage.removeItem("al fadly - crmprimaryHoverColor");
      localStorage.removeItem("al fadly - crmprimaryBorderColor");
      localStorage.removeItem("al fadly - crmprimaryTransparent");
      localStorage.removeItem("al fadly - crmtransparentPrimaryColor");
      localStorage.removeItem("al fadly - crmtransparentBgColor");
      localStorage.removeItem("al fadly - crmtransparent-bgImgPrimaryColor");
      localStorage.removeItem("al fadly - crmBgImage");
    ...
    function transparentPrimaryColor() {
      ...
      localStorage.setItem("al fadly - crmtransparentPrimaryColor", userColor);
      localStorage.setItem("al fadly - crmprimaryHoverColor", userColor + 95);
      localStorage.setItem("al fadly - crmprimaryBorderColor", userColor);
      localStorage.setItem("al fadly - crmprimaryTransparent", userColor + 20);
    ...
    function BgTransparentBackground() {
      ...
      localStorage.setItem("al fadly - crmtransparentBgColor", userColor);
    ...
    function BgImgTransparentPrimaryColor() {
      ...
      localStorage.setItem("al fadly - crmtransparent-bgImgPrimaryColor", userColor);
...
// console.log(dynamicPrimaryImgTransparent);
      ...
      if (
        ...
        localStorage.setItem("al fadly - crmBgImage", "bg-img1");
      }
      Switcherdata.name();
                ...
                <div className="predefined_styles">
                  <div className="swichermainleft text-center">
                    <div className="p-3 d-grid gap-2">
                      <a
                       target="blank"
                        href="https://react.spruko.com/al fadly - crm/"
                      ...
                      <a
                       target="blank"
                        href="https://themeforest.net/item/al fadly - crm-react-js-admin-dashboard-template/39360388"
                    ...
                    <div className="skin-body">
                      <div className="switch_section">
                        ...
                        <div className="switch-toggle">
                          ...
                          >
                            <img
                              src={new URL('../../assets/img/media/bg-img1.jpg', import.meta.url).href}
                              id="bgimage1"
                              alt="switch-img"
                            />
                          </Link>
                          ...
                          >
                            <img
                              src={new URL('../../assets/img/media/bg-img2.jpg', import.meta.url).href}
                              id="bgimage2"
                              alt="switch-img"
                            />
                          </Link>
                          ...
                          >
                            <img
                              src={new URL('../../assets/img/media/bg-img3.jpg', import.meta.url).href}
                              id="bgimage3"
                              alt="switch-img"
                            />
                          </Link>
                          ...
                          >
                            <img
                              src={new URL('../../assets/img/media/bg-img4.jpg', import.meta.url).href}
                              id="bgimage4"
                              alt="switch-img"
                            />
                          </Link>
