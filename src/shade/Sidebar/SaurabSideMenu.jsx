const SAURAB_SIDE_MENU = [
    {
      menutitle: "Manage History",
      Items: [
        {
          path: `${process.env.PUBLIC_URL}/history/manage-history`,
          icon: (
            <svg
    ...
    },
    {
      ...
      Items: [
        {
          path: `${process.env.PUBLIC_URL}/new-page`,
          icon: (
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="side-menu__icon"
    ...
    },
    {
      ...
      Items: [
        {
          path: `${process.env.PUBLIC_URL}/onsearch/outlet-details`,
          icon: (
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="side-menu__icon"
...
export default SAURAB_SIDE_MENU;
