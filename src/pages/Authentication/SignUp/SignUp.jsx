                    ...
                    <div className="wd-100p">
                      ...
                      <div className="">
                        <div className="main-signup-header">
                          ...
                          <h6 className="font-weight-normal mb-4">It's free to signup and only takes a minute.</h6>
                          ...
                          <Form action="#">
                            ...
                            <FormGroup className="form-group">
                              ...
                              <Form.Control className="form-control" placeholder="Enter your email" type="text" />
                            </FormGroup>
                            <FormGroup className="form-group">
