      ...
      <div className="page">
        <Row>
          <div className="d-flex">
            <Link className="demo-icon new nav-link" to="#" onClick={() => Switcherdatacustam.Swichermainright()}>
              <svg
        ...
        <div className="page-single" onClick={() => Switcherdatacustam.Swichermainrightremove()}>
          <div className="container">
            <Row>
              <Col xl={5} sm={8} xs={10} lg={6} md={8} className="card-sigin-main py-4 justify-content-center mx-auto">
                  ...
                  <div className="main-card-signin d-md-flex">
                    <div className="wd-100p">
                      <div className="d-flex mx-auto">
                        {' '}
                        <Link to={`${process.env.PUBLIC_URL}/`} className="mx-auto d-flex">
                          <img
